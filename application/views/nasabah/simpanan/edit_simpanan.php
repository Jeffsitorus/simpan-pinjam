      ...
      <div class="card mt-3">
        <div class="card-body">
          <div class="col-6 offset-3">
            <form action="<?= site_url('simpanan/edit/'. $simpanan['id_simpanan']); ?>" method="post">
              ...
              <div class="form-group">
                ...
                <input type="text" name="total" value="<?= $simpanan['total']; ?>" id="total" class="form-control" placeholder="Rp.0">

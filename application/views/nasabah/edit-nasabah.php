      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-body">
                <form action="<?= site_url('nasabah/edit/'.$nasabah['id_nasabah']); ?>" method="post" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-6">
                      <div class="form-group">
                        <label for="nik">NIK<sup class="text-danger">*</sup></label>
                        <input type="text" name="nik" id="nik" value="<?= $nasabah['nik']; ?>" class="form-control" placeholder="Masukkan nik">
                        <?= form_error('nik', '<div class="text-danger small">', '</div>'); ?>
                      </div>
                      <div class="form-group">
                        <label for="nama">Nama Lengkap<sup class="text-danger">*</sup></label>
                        <input type="text" name="nama" id="nama" value="<?= $nasabah['nama']; ?>" class="form-control" placeholder="Masukkan nama">
                        <?= form_error('nama', '<div class="text-danger small">', '</div>'); ?>
                      </div>
                      <div class="form-group">
                        <label for="username">Username<sup class="text-danger">*</sup></label>
                        <input type="text" name="username" id="username" value="<?= $nasabah['username']; ?>" class="form-control" placeholder="Masukkan username" readonly>
                        <?= form_error('username', '<div class="text-danger small">', '</div>'); ?>
                      </div>
                      <div class="form-group">
                        <label for="usia">Usia<sup class="text-danger bold">*</sup></label>
                        <input type="text" name="usia" id="usia" value="<?= $nasabah['usia']; ?>" class="form-control" placeholder="Masukkan usia">
                    ...
                    <div class="col-6">
                      <div class="form-group">
                        ...
                        <input type="tel" name="no_telepon" id="no_telepon" value="<?= $nasabah['telepon']; ?>" class="form-control" placeholder="Misal +620180281">
                      ...
                      <div class="form-group">
                        ...
                        <span>Format file jpg|jpeg|png maksimal 1MB.</span>
                      </div>
                      <div class="form-group">

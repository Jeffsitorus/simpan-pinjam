      ...
      <div class="card mt-3">
        <div class="card-body">
          <div class="col-6 offset-3">
            <form action="<?= site_url('peminjaman/edit/'. $peminjaman['id']); ?>" method="post">
              ...
              <div class="form-group">
                ...
                <input type="text" name="nominal" id="nominal" value="<?= $peminjaman['nominal'] ?>" class="form-control" placeholder="Rp.0">
                <?= form_error('nominal', '<div class="text-danger small">', '</div>'); ?>
              </div>
              <div class="form-group">
                <label for="durasi">Jangka Waktu</label>
                <input type="text" name="durasi" id="durasi" value="<?= $peminjaman['durasi'] ?>" class="form-control" placeholder="Misal : 3 bulan, 9 atau 12 bulan">
                <?= form_error('durasi', '<div class="text-danger small">', '</div>'); ?>
              </div>
              <div class="form-group">
                <label for="bunga_pinjam">Bunga Pinjaman</label>
                <input type="text" name="bunga_pinjam" id="bunga_pinjam" value="<?= $peminjaman['bunga_pinjam']; ?>" class="form-control" placeholder="Rp.0" readonly>
